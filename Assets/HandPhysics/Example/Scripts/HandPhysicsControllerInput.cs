...
public class HandPhysicsControllerInput : MonoBehaviour
{
    ...
    {
        if (Camera.main != null)
            Camera.main.transform.position = Vector3.Lerp(Camera.main.transform.position, _handController.HandParts[0][0].transform.position + new Vector3(0, 7, 4), Time.deltaTime * 15);
    }
